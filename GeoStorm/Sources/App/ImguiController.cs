...
namespace ImGuiDemo
{
    ...
    public class ImguiController : IDisposable
    {
        ...
        void UpdateKeyboard()
        {
            ...
            {
                io.KeysDown[i] = IsKeyDown((KeyboardKey)i);
            }
        ...
        void UpdateMouse()
        {
            ...
            {
                io.MouseDown[i] = IsMouseButtonDown((MouseButton)i);
            }
            ...
            // Mouse cursor state
            if ((io.ConfigFlags & ImGuiConfigFlags.NoMouseCursorChange) == 0 || IsCursorHidden())
            {
        ...
        void RenderCommandLists(ImDrawDataPtr data)
        {
            ...
            for (int n = 0; n < data.CmdListsCount; n++)
            {
                ...
                for (int cmdi = 0; cmdi < cmdList.CmdBuffer.Size; cmdi++)
                {
                    ...
                    Rlgl.rlScissor(rectX, GetScreenHeight() - (rectY + rectH), rectW, rectH);
